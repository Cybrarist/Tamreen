<template>
  <div ref="refElement" class="cursor-pointer container-style duration-[var(--duration)] ease-[var(--easing)] delay-[var(--delay)] container relative isolate w-full transition-transform will-change-transform [aspect-ratio:1/1.7] [contain:layout_style] [perspective:600px]" @pointermove="handlePointerMove" @pointerenter="handlePointerEnter" @pointerleave="handlePointerLeave">
